...
> extends GPUObjectDescriptorBase {
   ...
   */
  pipelineStatistics?: IDLSequence<
...
type GPURenderPipelineDescriptor<
  Mut extends boolean = boolean
> =
  | GPURenderPipelineDescriptorNew<Mut>
  | GPURenderPipelineDescriptorOld;
interface GPURenderPipelineDescriptorNew<
  Mut extends boolean = boolean
> extends GPUPipelineDescriptorBase {
  vertex: GPUVertexState<Mut>;
  primitive?: GPUPrimitiveState;
  depthStencil?: GPUDepthStencilState;
  multisample?: GPUMultisampleState;
  fragment?: GPUFragmentState<Mut>;
}
...
interface GPUObjectBase {
   ...
   * Mut any given situation, the user agent may or may not choose to use this label.
   */
  label:
    | string
    | null;
...
interface GPUAdapter {
   ...
   */
  requestDevice(
    descriptor?: GPUDeviceDescriptor<false>
  ): Promise<GPUDevice>;
}
...
interface GPUCommandBuffer
   ...
   * Mut {@link GPUCommandEncoder#finish}, it should be specified that a
   ...
   * Mut {@link GPUQueue#submit}, it should be specified that (if
...
interface GPUCommandEncoder
   ...
   */
  beginRenderPass(
    descriptor: GPURenderPassDescriptor<false>
...
interface GPUDevice
  ...
  createBindGroupLayout(
    descriptor: GPUBindGroupLayoutDescriptor<false>
  ): GPUBindGroupLayout;
  /**
  ...
  createPipelineLayout(
    descriptor: GPUPipelineLayoutDescriptor<false>
  ): GPUPipelineLayout;
  /**
   ...
   */
  createBindGroup(
    descriptor: GPUBindGroupDescriptor<false>
  ): GPUBindGroup;
  /**
  ...
  createRenderPipeline(
    descriptor: GPURenderPipelineDescriptor<false>
  ): GPURenderPipeline;
  /**
  ...
  createRenderBundleEncoder(
    descriptor: GPURenderBundleEncoderDescriptor<false>
   ...
   */
  createQuerySet(
    descriptor: GPUQuerySetDescriptor<false>
  ): GPUQuerySet;
...
/** @deprecated */
type GPUVertexBufferLayoutDescriptor = GPUVertexBufferLayout<false>;
/** @deprecated */
